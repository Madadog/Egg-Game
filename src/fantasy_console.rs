...
impl FantasyConsole {
    pub fn new() -> Self {
        ...
        let mut string = String::from("");
        string.push_str("");
        string.push_str("");
        string.push_str("");
        x.load_sprite_flags(&string);
        x
    }
