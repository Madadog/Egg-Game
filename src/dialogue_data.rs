...
pub const THING: &[TextContent] = &[
    ...
    Pause,
    Portrait(Some(&portraits::HORROR.to())),
    AutoText("And so I DID pick literally any form."),
    Pause,
    Portrait(Some(&portraits::Y_OOF.to())),
    AutoText("Any OTHER form!"),
    Pause,
    Portrait(Some(&portraits::HORROR.to())),
    AutoText("What's wrong with this one in particular?"),
    ...
    Pause,
    Portrait(Some(&portraits::HORROR.to())),
    AutoText("Yes, but you fail to grasp just how BAD my codebase REALLY IS..."),
    Pause,
    Portrait(Some(&portraits::Y_LOOK.to())),
    AutoText("..."),
    Delayed("\n...", 30),
    Delayed("\n... How bad can a codebase BE, really?", 30),
    Pause,
    Portrait(Some(&portraits::HORROR.to())),
    AutoText("Well, let's take petting the dog, for instance."),
    Pause,
    Portrait(Some(&portraits::HORROR.to())),
    ...
    Pause,
    Portrait(Some(&portraits::Y_LOOK.to())),
    AutoText("... Is this why I'm still wandering around an empty map devoid of content or living creatures even after literal weeks of development?"),
    Pause,
    Portrait(Some(&portraits::HORROR.to())),
    ...
    Portrait(Some(&portraits::Y_AWAY.to())),
    AutoText("... Wow."),
    Delayed(" That is in REALLY poor taste.", 30),
    Delayed("\n...", 30),
    ...
    Pause,
    Portrait(Some(&portraits::HORROR.to())),
    AutoText("On the topic of moral responsibility,"),
    ...
    Pause,
    Portrait(Some(&portraits::Y_REGRET.to())),
    AutoText("I should have been in a different game..."),
];
