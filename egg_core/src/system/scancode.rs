...
pub enum ScanCode {
    ...
    Minus = 37, Equals, LeftBracket, RightBracket, Backslash,
    Semicolon, Apostrophe, Grave, Comma, Period, Slash,
    Space = 48, Tab, Return, Backspace, Delete, Insert,
    PageUp, PageDown, Home, End,
    Up = 58, Down, Left, Right,
    CapsLock = 62, Ctrl, Shift, Alt,
    Escape = 66,
    F1 = 67, F2, F3, F4, F5, F6, F7, F8, F9, F10, F11, F12,
}
