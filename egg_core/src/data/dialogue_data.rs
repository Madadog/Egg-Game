...
pub const GAME_TITLE_BLURB: &str = "version 0.1.0\0";
...
pub const MAYOR_DESK_FRONT: &str = "It's made of cardboard.";
pub const MAYOR_DESK_BACK: &str = "It's stuffed full of straw. There's a water bottle and a pellet feeder.";
pub const MAYOR_PLANT: &str = "It clings to the light.";
pub const MAYOR_EXIT: &str = "The valve won't budge.";
pub const MAYOR_VENDING_MACHINE: &str = "One of the buttons is worn and faded with use. Press it?";
pub const MAYOR_VENDING_MACHINE_AFTER: &[&str] = &["You got: Rabbit food.", "... Hooray."];